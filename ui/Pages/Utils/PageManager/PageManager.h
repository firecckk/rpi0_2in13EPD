...
private:
    ...
    /* Root */
    static void onRootDragEvent();
    static void onRootDragAnimFinish();
    static void onRootAsyncLeave(void* base);
    void RootEnableDrag();
    static void RootGetDragPredict();

    /* Switch */
    bool SwitchTo(PageBase* base, bool isEnterAct, const PageBase::Stash_t* stash = nullptr);
    static void onSwitchAnimFinish();
